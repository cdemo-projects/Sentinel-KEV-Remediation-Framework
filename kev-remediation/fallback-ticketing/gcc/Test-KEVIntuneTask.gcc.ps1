...
.EXAMPLE
    .\Test-KEVIntuneTask.gcc.ps1 -TriggerUrl "<value-from-Deploy-output>"
#>
[CmdletBinding()]
param(
...
if ($response.taskId) {
    ...
    Write-Host "  https://intune.microsoft.com > Endpoint security > Security tasks" -ForegroundColor White
