<#
.SYNOPSIS
    Deploys the KEV-ServiceNow-v1 Logic App (GCC) — creates ServiceNow incidents from KEV CVE matches.
...
param(
    ...
    [string]$DefenderTenantUrl    = "https://security.microsoft.com"
)

$ErrorActionPreference = "Stop"

$defPath = Join-Path $PSScriptRoot "KEV-ServiceNow-v1.gcc.json"
...
Write-Host "  .\Test-KEVServiceNow.gcc.ps1 -TriggerUrl `"$($cb.value)`"" -ForegroundColor DarkGray
