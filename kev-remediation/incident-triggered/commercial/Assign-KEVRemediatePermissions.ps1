...
#   DeviceManagementApps.ReadWrite.All     - assign apps to groups (existing assignments only need Read; we keep ReadWrite for setup)
#   Group.Read.All                          - read members of universal ring groups
#   GroupMember.ReadWrite.All               - add/remove devices to per-app AppPatch groups at incident time
#   DeviceManagementManagedDevices.PrivilegedOperations.All  - (already present) syncDevice nudge for KEV-urgent CVEs
