...
Next steps:
  1. Enroll device01: Settings > Accounts > Access work or school > Enroll only in device management
  2. Add device01 device object to Intune-Windows-Pilot-Devices
