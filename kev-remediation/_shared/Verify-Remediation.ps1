...
.EXAMPLE
    # WUfB / KB path
    .\Verify-Remediation.ps1 -DeploymentId '<deployment-id>' `
        -CveId 'CVE-2026-21513' -DeviceName 'device01' `
        -WorkspaceName '<workspace-name>' -ResourceGroup '<resource-group>'

.EXAMPLE
    # Third-party / Intune path
    .\Verify-Remediation.ps1 -IntuneRemediationScriptId '<intune-remediation-script-id>' `
        -CveId 'CVE-2026-12345' -DeviceName 'device01' `
        -WorkspaceName '<workspace-name>' -ResourceGroup '<resource-group>'
#>
