...
# =============================================================================
# PURPOSE:
#   Gov-cloud variant of Assign-MDVMPermissions.ps1.
...
#
# WHEN TO RUN:
#   After deploying MDETVM-LogicApp.gov.json to an Azure US Government tenant.
...
Write-Host "Connecting to Azure US Government (Tenant: $TenantId)..." -ForegroundColor Cyan
Connect-AzAccount -TenantId $TenantId -Environment AzureUSGovernment

# Gov Microsoft Graph endpoint
