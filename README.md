...
> ⚠️ **Security note on `Mail.Send`:** This application permission lets the managed identity send email as **any user** in the tenant. Scope it down with an Exchange Application Access Policy:
>
> ```powershell
